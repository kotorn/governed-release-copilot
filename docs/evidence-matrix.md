...
| [03 Validation](video/scene-03-validation.txt) | C03, C05 |
...
| [07 Agent and Work IQ](video/scene-07-agent-work-iq.txt) | C07, C08, C12 |
| [08 Reliability and close](video/scene-08-reliability-close.txt) | C09, C10, C11 |
